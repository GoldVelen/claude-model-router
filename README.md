...
```json
{
  ...
  "backends": {
    ...
    "claude": {
      "url": "https://socheap.ai",
      "apiKey": "sk-your-socheap-key"
    }
  },
  "aliases": {
    "dsp": "deepseek-v4-pro",
...
```
/model opus   → claude-opus-4-7 via socheap.ai
/model dsp    → deepseek-v4-pro via api.deepseek.com
/model dsf    → deepseek-v4-flash via api.deepseek.com
/model sonnet → claude-sonnet-4-6 via socheap.ai
/model haiku  → claude-haiku-4-5 via socheap.ai
```
